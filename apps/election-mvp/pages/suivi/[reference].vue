  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm">
      <div class="max-w-4xl mx-auto px-4 py-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-2xl font-bold text-gray-900">Suivi de commande</h1>
            <p class="text-gray-600 mt-1">Référence: {{ reference }}</p>
          </div>
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
      ...
      <div v-if="pending" class="text-center py-12">
        ...
        <p class="mt-2 text-gray-600">Récupération des informations...</p>
      </div>

      <!-- Erreur -->
      <div v-else-if="error || (trackingData && !trackingData.success)" 
        ...
        <div class="flex items-center">
          ...
          <div class="ml-3">
            ...
            <div class="mt-4">
              <a href="mailto:commercial@ns2po.ci" 
                 class="text-red-600 hover:text-red-700 font-medium">
                📧 commercial@ns2po.ci
              </a>
              <span class="mx-2 text-red-400">|</span>
              <a href="tel:+2250575129737" 
                 class="text-red-600 hover:text-red-700 font-medium">
                📞 +225 05 75 12 97 37
              </a>
            </div>
      ...
      <div v-else-if="trackingData && trackingData.success" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p class="text-gray-600">{{ trackingData.customer?.email }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <div v-for="(item, index) in trackingData.order?.items" 
                 :key="index" 
        ...
        <!-- Timeline de suivi -->
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-6">Suivi de votre commande</h3>
          <div class="space-y-6">
            <div v-for="(event, index) in trackingData.timeline" 
                 :key="index" 
        ...
        <!-- Statut de paiement -->
        <div v-if="trackingData.order?.paymentStatus !== 'paid'" 
        ...
        <div v-if="trackingData.order?.notes" class="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 class="font-medium text-blue-900 mb-2">Notes</h3>
          <p class="text-blue-800">{{ trackingData.order.notes }}</p>
        </div>
