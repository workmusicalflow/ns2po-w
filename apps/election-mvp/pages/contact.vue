            ...
            <div class="space-y-4">
              <div>
                ...
                <p class="text-sm text-gray-600">
                  7 à 14 jours ouvrés selon quantité
                </p>
              </div>
              ...
              <div>
                ...
                <p class="text-sm text-gray-600">
                  25 à 50 pièces selon le produit
                </p>
              </div>
            ...
            <div class="space-y-4">
              <div class="border-l-4 border-blue-500 pl-4">
                <p class="text-sm text-gray-600 italic">
                  "Service impeccable, délais respectés!"
                </p>
                <p class="text-xs text-gray-500 mt-1">
                  - Parti Démocratique, Abidjan
                </p>
              </div>
              ...
              <div class="border-l-4 border-orange-500 pl-4">
                ...
                <p class="text-xs text-gray-500 mt-1">
                  - Candidat Indépendant, San Pedro
                </p>
              </div>
            </div>
          </Card>
