 ...
 */
export function cloudinaryImageToHybridRealisation(image: any): HybridRealisation {
  ...
  return {
    ...
    cloudinaryUrls: [
      `https://res.cloudinary.com/dsrvzogof/image/upload/w_800,h_600,c_fill,f_auto,q_auto/${image.public_id}`
    ],
    productIds: [],
    categoryIds: [],
 ...
 */
export function generateCloudinaryUrls(publicIds: readonly string[]): readonly string[] {
