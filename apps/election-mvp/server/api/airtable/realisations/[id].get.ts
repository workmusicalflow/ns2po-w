    ...
    const mockRealisations: Realisation[] = [
      {
        ...
        description:
          "T-shirt personnalisé avec logo de campagne et slogan inspirant, impression haute qualité en sérigraphie. Cette réalisation montre un excellent exemple de personnalisation textile pour campagne politique avec un design moderne et percutant.",
        cloudinaryPublicIds: [
          "ns2po-elections-mvp/realisations/tshirt-campagne-ensemble",
        ],
      ...
      products: [
        {
          ...
          description:
            "T-shirt 100% coton personnalisable avec logo et slogan de campagne",
          category: "textile",
          basePrice: 2500,
          minQuantity: 50,
          maxQuantity: 5000,
